...
namespace MRZ
{
    ...
    {
        private const string Filler = "<"; // const string enables compile-time interpolation of line patterns (18 - 25% less execution time and allocated memory)
        private const int Td1LineLength = 30;
        private const int Td2MrvbIdfraLineLength = 36;
        private const int Td3MrvaLineLength = 44;
        ...
        public Document(string mrz)
        {
            ...
            {
                case Td1LineLength * 3:
                    DocumentFormat = MrzFormat.TD1;
                    break;
                case Td2MrvbIdfraLineLength * 2:
